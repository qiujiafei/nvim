...
_G.packer_plugins = {
  ...
  ["close-buffers"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/close-buffers",
    url = "https://github.com/Asheq/close-buffers"
  },
  ["cmp-buffer"] = {
    loaded = true,
  ...
  ["specs.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/specs.nvim",
  ...
  ["telescope-undo.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/telescope-undo.nvim",
  ...
  ["tmux-navigate"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/tmux-navigate",
  ...
  ["vim-cool"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/vim-cool",
